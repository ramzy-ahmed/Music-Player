...
public class MainActivity extends AppCompatActivity implements SongAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.recyclerVewSongs.setLayoutManager(new LinearLayoutManager(this));
    ...
    private void loadSongs(){
        ...
        binding.recyclerVewSongs.setAdapter(adapter);
    }
...
//    }
    ...
    @Override
    public void onItemClick(int position) {
        DataHelper.getInstance().setSongList(songList);
        Intent intent = new Intent(MainActivity.this, PlayerActivity.class);
        intent.putExtra("position", position);
        startActivity(intent);
    }
